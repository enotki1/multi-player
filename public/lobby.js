...
(function () {
  ...
  function createLobbyDOM() {
    ...
    const controlsLine = document.createElement("p");
    controlsLine.id = "lobby-controls";
    controlsLine.className = "lobby-controls";
    controlsLine.textContent =
      "Controls: A/D Move · W Jump · Space Attack · Shift Block · M Mute";
    ...
    panel.appendChild(controlsLine);
